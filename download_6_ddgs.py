...
chains = [
    ("icon_kappasushi.png", "かっぱ寿司 ロゴ"),
    ("icon_ringerhut.png", "リンガーハット ロゴ"),
    ("icon_joyfull.png", "ジョイフル ロゴ"),
    ("icon_bamiyan.png", "バーミヤン ロゴ"),
    ("icon_doutor.png", "ドトールコーヒー ロゴ"),
    ("icon_tullys.png", "タリーズコーヒー ロゴ")
]
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if 'html' in content_type:
                return False
            # ファイルサイズチェック（小さすぎたり、HTMLだったりするのを防ぐ）
