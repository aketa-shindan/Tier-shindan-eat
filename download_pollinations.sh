...
declare -a prompts=(
"Anime style illustration of a broke but happy college student worshipping a plate of cheap pasta, funny internet meme style, exaggerated expression"
"Anime style illustration of a smug hipster wearing glasses, typing on a Macbook in a stylish cafe with a coffee cup, acting like a gourmet food critic, funny internet meme style"
"Anime style illustration of a chubby geeky guy happily eating a giant bowl of greasy ramen and dumplings, sweating, funny internet meme style"
...
for i in "${!files[@]}"; do
    ...
    curl -sL -m 20 "$url" -o "$DST_DIR/$filename"
    
    # Check if the file is actually a valid JPEG/PNG, not HTML or empty
